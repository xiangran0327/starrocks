...
public class JsonMetricVisitor extends MetricVisitor {
    ...
    public void getNodeInfo() {
        ...
        buildMetric(NODE_INFO, "nounit", String.valueOf(GlobalStateMgr.getCurrentState().getFrontends(null).size()),
                Arrays.asList(new MetricLabel("type", "fe_node_num"), new MetricLabel("status", "total")));
        buildMetric(NODE_INFO, "nounit", String.valueOf(GlobalStateMgr.getCurrentSystemInfo().getTotalBackendNumber()),
                Arrays.asList(new MetricLabel("type", "be_node_num"), new MetricLabel("status", "total")));
        buildMetric(NODE_INFO, "nounit", String.valueOf(GlobalStateMgr.getCurrentSystemInfo().getAliveBackendNumber()),
                Arrays.asList(new MetricLabel("type", "be_node_num"), new MetricLabel("status", "alive")));
        buildMetric(NODE_INFO, "nounit",
                String.valueOf(GlobalStateMgr.getCurrentSystemInfo().getDecommissionedBackendIds().size()),
        ...
        buildMetric(NODE_INFO, "nounit", String.valueOf(
                        GlobalStateMgr.getCurrentState().getBrokerMgr().getAllBrokers().stream().filter(b -> !b.isAlive)
                                .count()),
                Arrays.asList(new MetricLabel("type", "be_node_num"), new MetricLabel("status", "dead")));

        buildMetric(NODE_INFO, "nounit",
                String.valueOf(GlobalStateMgr.getCurrentSystemInfo().getTotalComputeNodeNumber()),
                Arrays.asList(new MetricLabel("type", "cn_node_num"), new MetricLabel("status", "total")));
        buildMetric(NODE_INFO, "nounit",
                String.valueOf(GlobalStateMgr.getCurrentSystemInfo().getAliveComputeNodeNumber()),
